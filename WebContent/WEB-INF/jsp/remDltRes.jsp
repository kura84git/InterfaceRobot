...
<title>InterfaceRobot Reminder Delete Result</title>
</head>
<body>
	<div class="background-image">
		...
		<div class="main-content">
			...
			<div class="remDltRes-main-cover">
				<div class="remDltRes-mainBox">
					<% if(remRes) { %>
						<p class="word">削除が完了しました！！</p>
					<% } else { %>
						<p class="word">削除に失敗しました・・・</p>
					<% } %>
				</div>
			</div>
		</div>
